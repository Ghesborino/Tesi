...
public class GraficoController {
    ...
    void initialize() {
        ...
        final int operazioniMassime = PythonTempoPerEseguireGraficoLD.OPERAZIONI_MASSIME == 0 ? 10000 : PythonTempoPerEseguireGraficoLD.OPERAZIONI_MASSIME;
        final int esecutori = Math.round(PythonTempoPerEseguireGraficoLD.ESECUTORI_MOLTIPLICATORE == 0 ? Runtime.getRuntime().availableProcessors() : Runtime.getRuntime().availableProcessors() * PythonTempoPerEseguireGraficoLD.ESECUTORI_MOLTIPLICATORE);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        while(i.hasNext()) {
                            ...
                            final int operazioniF = data.getInt("richieste");
