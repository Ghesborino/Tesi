...
public class GraficoController {
    ...
    void initialize() {
        ...
        final float tempoIO = PythonTempoPerEseguireFixIOGraficoRT.TEMPO_IO == 0 ? 5f : PythonTempoPerEseguireFixIOGraficoRT.TEMPO_IO;
        final int esecutori = Math.round(PythonTempoPerEseguireFixIOGraficoRT.ESECUTORI_MOLTIPLICATORE == 0 ? Runtime.getRuntime().availableProcessors() : Runtime.getRuntime().availableProcessors() * PythonTempoPerEseguireFixIOGraficoRT.ESECUTORI_MOLTIPLICATORE);
        ...
        startBTN.setOnAction(e -> {
            ...
            new Thread(new Runnable() {
                        ...
                        for(float tempo = 1f; tempo <= tempoIO; tempo += 1f) {
                            ...
                            if(risultato != null) {
                                ...
                                Platform.runLater(() -> {
                                    ...
                                    multithreadingSerie.getData().add(new XYChart.Data<String, Float>("" + tempoF, multithreadingTime));
                                    multiprocessingSerie.getData().add(new XYChart.Data<String, Float>("" + tempoF, multiprocessingTime));
                                });
                            }
                        }
                ...
                private String runPY(float tempo, int numeroEsecutori) {
                    ...
                    try {
                        ...
                        Process p = Runtime.getRuntime().exec("py main.py " + tempo + " " + numeroEsecutori);
