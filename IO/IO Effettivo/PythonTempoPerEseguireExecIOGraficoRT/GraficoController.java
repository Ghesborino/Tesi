...
public class GraficoController {
    ...
    void initialize() {
        ...
        final int ripetizioniOUT = PythonTempoPerEseguireExecIOGraficoRT.RIPETIZIONI == 0 ? 50 : PythonTempoPerEseguireExecIOGraficoRT.RIPETIZIONI;
        final int esecutori = Math.round(PythonTempoPerEseguireExecIOGraficoRT.ESECUTORI_MOLTIPLICATORE == 0 ? Runtime.getRuntime().availableProcessors() : Runtime.getRuntime().availableProcessors() * PythonTempoPerEseguireExecIOGraficoRT.ESECUTORI_MOLTIPLICATORE);
                    ...
                    try {
                        ...
                        for(int ripetizioni = 10; ripetizioni <= ripetizioniOUT; ripetizioni += 10) {
                            ...
                            if(risultato != null) {
                                ...
                                final int ripetizioniF = ripetizioni;
