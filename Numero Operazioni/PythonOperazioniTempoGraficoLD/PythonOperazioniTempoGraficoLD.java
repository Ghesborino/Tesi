...
public class PythonOperazioniTempoGraficoLD extends Application {

    public static float TEMPO_ESECUZIONE_MASSIMO = 0f;
    public static float ESECUTORI_MOLTIPLICATORE = 0;

    public static void main(String[] args) {

        if(args != null && args.length > 0) {
            TEMPO_ESECUZIONE_MASSIMO = Float.parseFloat(args[0]);
        }
